...
class_names = ["anjing", "ayam", "kucing", "kupu-kupu", "sapi"]
...
def predict_image(image):
    ...
    model_file = 'Deep Learning project.h5'
...
demo = gr.Interface(
    ...
    outputs=gr.Textbox(),
    title="Klasifikasi Gambar Anjing, Ayam, Kucing, Kupu-Kupu dan Sapi",
    description="Unggah gambar anjing, ayam, kucing, kupu-kupu atau sapi, dan model akan mengklasifikasikannya."
)
